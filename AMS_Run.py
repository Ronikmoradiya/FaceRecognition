...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            connection = pymysql.connect(host='localhost', user='root', password='', db='ams_manually_fill_attendance')
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='F:\7th sem\Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"F:\7th sem\Attendace_management_system-master\Attendance\Manually Attendance"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                cs = 'F:/7th sem/Attendace_management_system-master/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"F:\7th sem\Attendace_management_system-master\Attendance"')
    ...
    def log_in():
        ...
        if username == 'kushal' :
            if password == 'kushal14320':
                ...
                cs = 'F:/7th sem/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
